...
static void UpdateSurface(void)
{
    Uint8 *data;
    int x, y;
...
int main(int argc, char *argv[])
{
    ...
    window = SDL_CreateWindow("Palette Test", WINDOW_WIDTH, WINDOW_HEIGHT, 0);
    if (window == NULL) {
    ...
    /* FIXME: This only picks a SDL_PIXELFORMAT_INDEX8 mode because of a bug! */
    if (SDL_GetClosestFullscreenDisplayMode(SDL_GetDisplayForWindow(window), WINDOW_WIDTH, WINDOW_HEIGHT, 0.0f, false, &closest))
