if(CMAKE_SYSTEM_NAME STREQUAL "DOS")
  function(SDL_Preseed_CMakeCache)
    ...
    # SIMD intrinsics: disabled for DOS. The DJGPP cross-compiler (GCC 14.x on
    # a modern host) can *compile* SSE/AVX/MMX, but no real DOS target machine
    # supports them. Enabling these caused audio breakage. SDL3's target-attribute
    # pattern would theoretically gate on CPUID at runtime, but it's not worth
    # the risk — disable them all so SDL_DISABLE_* is set and no SIMD code is
